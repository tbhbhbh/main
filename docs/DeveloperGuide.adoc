...
The follow sequence diagram shows how the tag edit operation works:
...
it is `friends` and `losers`) provided by the user and it will return `TagEditCommand`. Next, `TagEditCommand`
