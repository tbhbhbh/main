...
The import mechanism is facilitated by Google's People API. It supports reading contacts from the user's personal Google account and parsing them into a format that can be added to the address book. Currently the import mechanism only supports
