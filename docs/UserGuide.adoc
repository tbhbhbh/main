...
This section shows existing features and future features to be implemented in HitMeUp.
...
* Multiple themes to customize HitMeUp
* Secure HitMeUp with a PIN
...
* The index refers to the index number shown in the most recent listing.
* The index must be a positive integer 1, 2, 3, ...
* The data folder directory where the vCard file ("contacts.vcf") is located will be displayed after a successful export.
...
* Opens the default mail application in your desktop with the email addresses of the specified persons
****
