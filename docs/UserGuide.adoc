...
* If the edited person's name is changed and it ends up affecting the alphabetical ordering, the list of people will be re-sorted to maintain the ordering.
