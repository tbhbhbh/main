...
Shows a list of all persons in HitMeUp. +

Format: `list`

=== Editing a person : `edit`

Edits an existing person in HitMeUp. +
...
Allows you to add an alias for any command used in HitMeUp.
