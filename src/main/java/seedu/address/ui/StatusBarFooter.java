...
public class StatusBarFooter extends UiPart<Region> {
    ...
    @FXML
    private StatusBar numberOfPersons;


    public StatusBarFooter(String saveLocation, int numberOfPersons) {
        super(FXML);
    ...
    private void setNumberOfPersons(int numberOfPersons) {
        Platform.runLater(() -> this.numberOfPersons.setText(numberOfPersons + " person(s) total"));
    }
    ...
    public void handleAddressBookChangedEvent(AddressBookChangedEvent abce) {
        ...
        setNumberOfPersons(abce.data.getPersonList().size());
    }
}
