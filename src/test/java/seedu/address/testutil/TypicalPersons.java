...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("85355255").withBirthday("01/03/1990").withDisplayPic("data/images/defaultperson.png")
            .withTags("friends").build();
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withBirthday("03/07/1886")
            .withDisplayPic("data/images/defaultperson.png").withTags("owesMoney", "friends").build();
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withBirthday("05/05/1997")
            .withDisplayPic("data/images/defaultperson.png").build();
    ...
    public static final ReadOnlyPerson AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withBirthday(VALID_BIRTHDAY_AMY).withDisplayPic(VALID_DISPLAYPIC)
            .withTags(VALID_TAG_FRIEND).build();
    public static final ReadOnlyPerson BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withBirthday(VALID_BIRTHDAY_BOB).withDisplayPic(VALID_DISPLAYPIC)
